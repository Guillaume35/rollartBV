...
#
# ClusterElement(element = ProgramElement, root = Frame, parent = BoxElement) Class
#
# Add a cluster element to a program with 2 modes : display or form. Form is for 
...
class ClusterElement():
    ...
    def form(self):
        ...
        # Base value
        btns = ['NLClS', 'ClSqB', 'ClSq1', 'ClSq2', 'ClSq3', 'ClSq4']
